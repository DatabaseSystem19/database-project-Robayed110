...
insert into deposit(NID_no,account_no,d_date,d_amount) values(3456789000,1234500,TO_DATE('2023-05-22', 'YYYY-MM-DD'),10000.00);
insert into deposit(NID_no,account_no,d_date,d_amount) values(3456789001,1234501,TO_DATE('2023-05-22', 'YYYY-MM-DD'),20000.00);
insert into deposit(NID_no,account_no,d_date,d_amount) values(3456789002,1234501,TO_DATE('2023-05-22', 'YYYY-MM-DD'),30000.00);
insert into deposit(NID_no,account_no,d_date,d_amount) values(3456789003,1234503,TO_DATE('2023-05-23', 'YYYY-MM-DD'),30000.00);
insert into deposit(NID_no,account_no,d_date,d_amount) values(3456789004,1234504,TO_DATE('2023-05-23', 'YYYY-MM-DD'),40000.00);
insert into deposit(NID_no,account_no,d_date,d_amount) values(3456789005,1234505,TO_DATE('2023-05-24', 'YYYY-MM-DD'),50000.00);
insert into deposit(NID_no,account_no,d_date,d_amount) values(3456789006,1234506,TO_DATE('2023-05-24', 'YYYY-MM-DD'),60000.00);
insert into deposit(NID_no,account_no,d_date,d_amount) values(3456789007,1234507,TO_DATE('2023-05-25', 'YYYY-MM-DD'),70000.00);
insert into deposit(NID_no,account_no,d_date,d_amount) values(3456789008,1234508,TO_DATE('2023-05-27', 'YYYY-MM-DD'),70000.00);
insert into deposit(NID_no,account_no,d_date,d_amount) values(3456789009,1234509,TO_DATE('2023-05-28', 'YYYY-MM-DD'),40000.00);
...
--customer details whose load amount= 400000: 
